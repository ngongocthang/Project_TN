...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        if (document.getElementById('success-message')) {
            setTimeout(function() {
                window.location.href = "{{ route('dashboard.product-solds.index') }}";
            }, 7000);
        }
    });
</script>
<main id="main" class="main">
    ...
    <div class="pagetitle">
        <h1>Form Product Sold</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
                <li class="breadcrumb-item"><a href="{{ route('dashboard.product-solds.index') }}">Product Sold</a></li>
            ...
            <div class="col-lg-10">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('dashboard.product-solds.update', $product->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row mb-3">
                                <label for="inputNumber" class="col-sm-2 col-form-label">Image</label>
                                <div class="col-sm-10">
                                    <img src="{{ asset('storage/'.$product->image) }}" style="width: 100px; height: 100px; border-radius: 50%;" alt="">
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select name="category_id" class="form-select" aria-label="Default select example">
                                        <option value="" disabled
                                            ...
                                            {{ $product->category_id ? $product->category->name : 'Chọn danh mục...' }}
                                        </option>
                            ...
                            <div class="row mb-3">
                                <div class="col-sm-12 text-end">
                                    <a href="{{ route('dashboard.product-solds.index') }}" class="btn-custom">Cancel</a>
