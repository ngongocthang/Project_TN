    ...
    <footer id="footer" class="footer layout-03">
        <div class="footer-content background-footer-03">
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-9">
                        <section class="footer-item">
                            <a href="#" class="logo footer-logo"><img src="./images/organic-3.png" alt="biolife logo" width="135" height="34"></a>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 md-margin-top-5px sm-margin-top-50px xs-margin-top-40px">
                        <section class="footer-item">
                                ...
                                <ul class="contact-lines">
                                    <li>
                                        <p class="info-item">
                                            ...
                                            <b class="desc">70 Nguyễn Huệ, P. Vĩnh Ninh, TP. Huế </b>
                                        </p>
                                    </li>
                                    <li>
                                        <p class="info-item">
                                            <i class="biolife-icon icon-phone"></i>
                                            <b class="desc">Phone: 0234-3822813 Fax: 0234-3845934</b>
                                        </p>
                                    </li>
                                    <li>
                                        <p class="info-item">
                                            <i class="biolife-icon icon-letter"></i>
                                            <b class="desc">Email:  cnhue@hueic.edu.vn</b>
                                        </p>
                                    </li>
                                </ul>
                            </div>
                            <div class="biolife-social inline">
                                <ul class="socials">
                                    <li><a href="https://www.facebook.com/quythien.le.50" title="facebook" class="socail-btn"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                                    <li><a href="#" title="twitter" class="socail-btn"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                                    <li><a href="#" title="pinterest" class="socail-btn"><i class="fa fa-pinterest" aria-hidden="true"></i></a></li>
                                    <li><a href="https://www.youtube.com/@gdpttaythanh" title="youtube" class="socail-btn"><i class="fa fa-youtube" aria-hidden="true"></i></a></li>
                                    <li><a href="https://www.instagram.com/crew_1606/?fbclid=IwY2xjawFR8lhleHRuA2FlbQIxMAABHQZuoYQ799a6bt9o6MwLvkhW7CO75W7q4Dwpj4C_18mLmTWzi0lV-DmxmQ_aem_-XUQo6gS1K1eJTGhJr-OmQ" title="instagram" class="socail-btn"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
                                </ul>
                            </div>
                        </section>
                    </div>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="separator sm-margin-top-10px xs-margin-top-40px"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="mobile-footer">
        <div class="mobile-footer-inner">
            ...
            <div class="mobile-block block-minicart">
                <a class="link-to-cart" href="/shopping-cart">
        ...
        <div class="block-global-contain">
            ...
            <div class="glb-item languages">
                ...
                <ul class="list inline">
                    <li class="list-item"><a href="#"><img src="./images/languages/us.jpg" alt="flag" width="24" height="18"></a></li>
                    <li class="list-item"><a href="#"><img src="./images/languages/fr.jpg" alt="flag" width="24" height="18"></a></li>
                    <li class="list-item"><a href="#"><img src="./images/languages/ger.jpg" alt="flag" width="24" height="18"></a></li>
                    <li class="list-item"><a href="#"><img src="./images/languages/jap.jpg" alt="flag" width="24" height="18"></a></li>
                </ul>
            </div>
        </div>
    </div>
